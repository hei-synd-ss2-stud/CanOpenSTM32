...
typedef struct {
    ...
    OD_obj_record_t o_2000_batteryInfo[4];
    OD_obj_var_t o_2001_status;
    OD_obj_var_t o_2002_errorMCU;
    OD_obj_var_t o_2003_shutdown_pwm;
    OD_obj_var_t o_2004_bus_voltage;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_batteryInfo = {
        {
            .dataOrig = &OD_RAM.x2000_batteryInfo.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2000_batteryInfo.voltage,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2000_batteryInfo.current,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2000_batteryInfo.energy,
            .subIndex = 3,
    ...
    .o_2001_status = {
        .dataOrig = &OD_RAM.x2001_status,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2002_errorMCU = {
        .dataOrig = &OD_RAM.x2002_errorMCU,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2003_shutdown_pwm = {
        .dataOrig = &OD_RAM.x2003_shutdown_pwm,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2004_bus_voltage = {
        .dataOrig = &OD_RAM.x2004_bus_voltage,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x04, ODT_REC, &ODObjs.o_2000_batteryInfo, NULL},
    {0x2001, 0x01, ODT_VAR, &ODObjs.o_2001_status, NULL},
    {0x2002, 0x01, ODT_VAR, &ODObjs.o_2002_errorMCU, NULL},
    {0x2003, 0x01, ODT_VAR, &ODObjs.o_2003_shutdown_pwm, NULL},
    {0x2004, 0x01, ODT_VAR, &ODObjs.o_2004_bus_voltage, NULL},
