...
********************************************************************************
    ...
    File info:
        ...
        Project File: DS301_profile_supply.xdd
        File Version: 1

        Created:      23.11.2020 13:00:00
        Created By:   
        Modified:     31.08.2026 10:07:17
        Modified By:  

    Device Info:
        Vendor Name:  Hes-so
        Vendor ID:    
        Product Name: Supply board
        Product ID:   04
...
#define OD_ENTRY_H1A03 &OD->list[27]
#define OD_ENTRY_H1A04 &OD->list[28]
#define OD_ENTRY_H2000 &OD->list[29]
#define OD_ENTRY_H2001 &OD->list[30]
#define OD_ENTRY_H2002 &OD->list[31]
#define OD_ENTRY_H2003 &OD->list[32]
#define OD_ENTRY_H2004 &OD->list[33]
...
#define OD_ENTRY_H1A03_TPDOMappingParameter &OD->list[27]
#define OD_ENTRY_H1A04_TPDOMappingParameter &OD->list[28]
#define OD_ENTRY_H2000_batteryInfo &OD->list[29]
#define OD_ENTRY_H2001_status &OD->list[30]
#define OD_ENTRY_H2002_errorMCU &OD->list[31]
#define OD_ENTRY_H2003_shutdown_pwm &OD->list[32]
#define OD_ENTRY_H2004_bus_voltage &OD->list[33]
